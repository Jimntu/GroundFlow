...
class BaseEvaluator():
    ...
    def update(self, data_dict):
        # metrics, confidence, correctness = self.batch_metrics(data_dict, include_count=True)
        metrics = self.batch_metrics(data_dict, include_count=True)
        # self.confidence.extend(confidence)
        # self.correctness.extend(correctness)
    ...
    def record(self):
        ...
        return is_best, self.eval_dict, self.confidence, self.correctness
