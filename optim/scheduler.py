...
def get_scheduler(cfg, optimizer, total_steps):
    warmup_steps = cfg.solver.sched.args.warmup_steps * cfg.num_gpu #5000
    lambda_func = lambda step: globals()[cfg.solver.sched.name](step, warmup_steps, total_steps) #warm_up_cosine
