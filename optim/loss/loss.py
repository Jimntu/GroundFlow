...
class Loss(nn.Module):
    def __init__(self, cfg):
        ...
        self.selected_keys = cfg.model.loss_list #vista:ground loss
        self.loss_weights = cfg.model.get('loss_weights', {}) #vista:ground loss, 10.0
    ...
    def forward(self, data_dict):
        all_losses = {}
        for k, fn in self.loss_fn.items(): #k:loss name, fn:loss function
            ...
            # print(data_dict)
            cur_loss = fn(data_dict) #input ground_logits and ground_labels
            ...
            cur_dict_loss = {k: v * self.loss_weights.get(k, 1.0) for k, v in cur_dict_loss.items()} #weighted average
